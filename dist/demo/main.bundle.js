...
var DemoComponent = (function () {
    ...
    DemoComponent.prototype.hello = function () { };
...
function convertSchemaToDraft6(schema, options) {
    ...
    Object.keys(newSchema)
        ...
        if (['definitions', 'dependencies', 'properties', 'patternProperties']
            ...
            newSchema[key] = __WEBPACK_IMPORTED_MODULE_0_lodash__["cloneDeep"](newSchema[key]);
        }
    });
    return newSchema;
}
...
function forEachCopy(object, fn, errors) {
    ...
    if ((Object(__WEBPACK_IMPORTED_MODULE_0__validator_functions__["o" /* isObject */])(object) || Object(__WEBPACK_IMPORTED_MODULE_0__validator_functions__["h" /* isArray */])(object)) && typeof object !== 'function') {
